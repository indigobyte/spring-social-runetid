...
/**
 * {@link org.springframework.beans.factory.xml.NamespaceHandler} for Spring Social Runetid.
 *
 * @author vkolodrevskiy
 */
public class RunetidNamespaceHandler extends AbstractProviderConfigNamespaceHandler {

    @Override
    protected AbstractProviderConfigBeanDefinitionParser getProviderConfigBeanDefinitionParser() {
        return new RunetidConfigBeanDefinitionParser();
    }
}
